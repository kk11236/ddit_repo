...
public class T02EnumTest {
	...
	public static void main(String[] args) {
		/*
		 	...
		 	3. valueOf("열거형상수이름") => 지정된 열거형에서 '열거형상수이름'과 일치하는 열거형 상수(객체)를 반환한다.
		 */
		...
		for(Season season : enumArr) {
			System.out.println(season.name() + " : " + season.getData());
		}
